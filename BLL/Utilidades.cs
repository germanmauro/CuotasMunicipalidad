...
namespace BLL
{
    public class Utilidades
    {
        ...
        public static string NumeroTexto(decimal value)
        {
            string dec;

            var entero = Convert.ToInt64(Math.Truncate(value));
            var decimales = Convert.ToInt32(Math.Round((value - entero) * 100, 2));
            if (decimales > 0)
            {
